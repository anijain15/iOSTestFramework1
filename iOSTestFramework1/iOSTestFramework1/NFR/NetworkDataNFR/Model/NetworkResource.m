...
-(NSMutableArray *) networkDataCounters {
    ...
    if (getifaddrs(&addrs) == 0)
    {
        ...
        while (cursor != NULL)
        {
            ...
            if (cursor->ifa_addr->sa_family == AF_LINK)
            {
                ...
                NSLog(@"%@",[NSString stringWithFormat:@"%s",cursor->ifa_name]);
    ...
    return [NSMutableArray arrayWithObjects:[NSNumber numberWithLong:WWANSent],[NSNumber numberWithLong:WWANReceived],
